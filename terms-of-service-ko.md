...
1. **포인트의 정의 및 용도**
   - 회원은 서비스 내에서 포인트(이하 "빵")를 구매하여 유료 콘텐츠를 이용할 수 있습니다.
   - 빵은 서비스 내 디지털 콘텐츠 이용을 위한 선불전자지급수단입니다.

2. **포인트 구매**
   - 포인트는 회사가 정한 결제 수단(앱스토어 인앱결제, 카카오페이 등)을 통해서만 구매할 수 있습니다.
   - 1회 최대 충전 금액은 10,000원입니다.

3. **포인트 양도 금지**
   - 포인트는 타인에게 양도, 이전, 증여, 상속할 수 없습니다.
   - 계정 간 포인트 이동은 불가능합니다.

4. **포인트 유효기간**
   - 충전된 포인트의 이용기간은 결제시점으로부터 1년 이내로 제한됩니다.
   - 유효기간 경과 시 포인트는 자동으로 소멸되며 복구할 수 없습니다.
   - 회원 탈퇴 시 보유한 포인트는 자동으로 소멸됩니다.

5. **환불 정책**
   - 충전된 포인트의 환불가능기간은 결제시점으로부터 1년 이내로 제한됩니다.
   - 결제 후 7일 이내이며 포인트를 전혀 사용하지 않은 경우에 한하여 환불이 가능합니다.
   - 포인트를 일부라도 사용한 경우 환불이 불가능합니다.
   - 자세한 환불 정책은 별도의 "환불 정책" 문서(https://smy383.github.io/esc-privacy-policy/refund-policy-ko.md)를 참조하시기 바랍니다.

6. **환불 처리**
   - 환불은 원칙적으로 결제한 수단과 동일한 방법으로 처리됩니다.
   - 환불 처리 기간은 영업일 기준 3~5일이 소요될 수 있습니다.
